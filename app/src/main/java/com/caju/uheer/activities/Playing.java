...
public class Playing extends FragmentActivity
{
    ...
    public void playOrStopChannel(View view) {
        ...
        if(currentFragment == currentPlaying){
            mFAB.setImageDrawable(getResources().getDrawable(R.drawable.ic_play_arrow_black_24dp));
            currentPlaying = -1;
            return;
        }
        ...
        mFAB.setImageDrawable(getResources().getDrawable(R.drawable.ic_stop_black_24dp));
    }
